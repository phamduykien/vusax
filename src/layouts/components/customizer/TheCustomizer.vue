            ...
            <div class="mt-4">
              ...
              <div>
                <vs-radio 
                  v-model="theme" 
                  class="mr-4" 
                  vs-value="light">Light</vs-radio>
                <vs-radio 
                  v-model="theme" 
                  class="mr-4" 
                  vs-value="dark">Dark</vs-radio>
                <vs-radio 
                  v-model="theme" 
                  vs-value="semi-dark">Semi Dark</vs-radio>
              </div>
            </div>
            <vs-divider/>
            ...
            <div class="mt-4">
              ...
              <div>
                <vs-radio 
                  ...
                  class="mr-4" 
                  vs-value="hidden">Hidden</vs-radio>
                <vs-radio 
                  v-model="navbarTypeLocal" 
                  class="mr-4" 
                  vs-value="static">Static</vs-radio>
                <vs-radio 
                  v-model="navbarTypeLocal" 
                  class="mr-4" 
                  vs-value="sticky">Sticky</vs-radio>
                <vs-radio 
                  v-model="navbarTypeLocal" 
                  vs-value="floating">Floating</vs-radio>
              </div>
            </div>
            <vs-divider/>
