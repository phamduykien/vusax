              ...
              <div class="p-8">
                ...
                <div class="social-login flex flex-wrap justify-between">
                  <div class="social-login-buttons flex flex-wrap items-center mt-4">
                    ...
                    <div 
                      ...
                      <svg 
                        ...
                        viewBox="0 0 264 512"><path 
                          fill="currentColor" 
                          d="M215.8 85H264V3.6C255.7 2.5 227.1 0 193.8 0 124.3 0 76.7 42.4 76.7 120.3V192H0v91h76.7v229h94V283h73.6l11.7-91h-85.3v-62.7c0-26.3 7.3-44.3 45.1-44.3z"/></svg>
                    </div>
                  ...
                  <vs-button 
                    class="mt-4" 
                    color="#eb5424" 
                    @click="loginAuth0">Auth0</vs-button>
                </div>
