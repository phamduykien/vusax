        ...
        <vx-card title="Related Questions">
          <ul class="bordered-items">
            <li 
              ...
              :key="que.id" 
              class="py-2"><router-link :to="que.answerUrl">{{ que.question }}</router-link></li>
          </ul>
        </vx-card>
      </div>
            ...
            <div class="flex items-center justify-between">
              <router-link 
                ...
                class="flex items-center"><feather-icon 
                  ...
                  class="mr-2" 
                  svg-classes="h-4 w-4"/> Previous Article</router-link>
              <router-link 
                to="/pages/knowledge-base/category/question" 
                class="flex items-center">Next Article <feather-icon 
                  icon="ChevronsRightIcon" 
                  class="ml-2" 
                  svg-classes="h-4 w-4"/></router-link>
            </div>
          </template>
        </vx-card>
      </div>
