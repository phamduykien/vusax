              ...
              <div class="twitter-feed-header flex items-center">
                ...
                <div class="leading-tight ml-3">
                  ...
                  <span class="flex items-center"><small>@{{ feed.authorUsername }}</small><feather-icon 
                    class="ml-1" 
                    icon="CheckIcon" 
                    svg-classes="h-3 w-3 bg-primary rounded-full text-white"/></span>
                </div>
              </div>
              ...
              <div class="flex justify-between">
                <div class="flex items-center">
                  <div class="flex items-center"><feather-icon 
                    class="mr-2" 
                    icon="HeartIcon" 
                    svg-classes="h-5 w-5"/> <span>{{ post.likes }}</span></div>
                ...
                <div class="flex items-center"><feather-icon 
                  ...
                  svg-classes="h-5 w-5"/> <span>{{ post.comments }}</span></div>
              </div>
            ...
            <li 
              ...
              <ul class="poll-options-result">
                <li 
                  ...
                  <vs-progress :percent="option.voted"/>
